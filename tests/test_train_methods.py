...
# Fixture to generate the necessary matrices and tensors
@pytest.fixture
...
def test_SORNet_initialization(generate_matrices):
    A, H, y, n, m, bs, _ = generate_matrices
...
def test_SORNet_forward(generate_matrices):
    A, H, y, n, _, bs, _ = generate_matrices
    model = SORNet(A, H, bs, y, device=device)
...
def test_train_model(generate_matrices):
    A, H, y, _, _, bs, solution = generate_matrices
    model = SORNet(A, H, bs, y, device=device)
...
def test_evaluate_model(generate_matrices):
    A, H, y, n, _, bs, solution = generate_matrices
    model = SORNet(A, H, bs, y, device=device)
