...
In this exmaple of diagram, it can show that \omega can be unfolded throught this network and can we got the optumin paramters based in the input of matrix
